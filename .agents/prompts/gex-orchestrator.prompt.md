...
After account selection is complete, execute the workflow by activating the `gex-orchestrator` skill, following Phase I (Audit & Regime), Phase II (Discovery & Sentiment), Phase III (Grading & Selection), and presenting Phase IV (Execution Handoff) for explicit user approval via `ask_question`.
