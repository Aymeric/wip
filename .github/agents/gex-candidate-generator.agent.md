...
2.  **Refine**: Draft specific improvements for this file: [.github/agents/gex-candidate-generator.agent.md](.github/agents/gex-candidate-generator.agent.md).
3.  **Execute**: Use the `edit` tools (e.g., `replace_string_in_file`) to apply these refinements directly to this file. 
    - You MUST use the exact file path: [.github/agents/gex-candidate-generator.agent.md](.github/agents/gex-candidate-generator.agent.md).
